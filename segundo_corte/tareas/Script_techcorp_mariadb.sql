...
select nombre_empleado, edad, salario from empleado;

-- 2. Salarios mayores a 4M
...
-- 4. Edad entre 30 y 40
select * from empleado where edad between 30 and 40;

-- 5. Contratados despues de 2020
select * 
from empleado 
where year(fecha_contratacion) > 2020;

-- 6. Cantidad de empleados por departamento
...
-- 8. Nombres que empiezan con A o C
select * 
from empleado 
where nombre_empleado regexp '^(A|C)';

-- 9. No pertenecen a IT
select e.* 
from empleado e
join departamento d on e.id_departamento_fk = d.id_departamento
where d.nombre_departamento != 'IT';

-- 10. Empleado con mayor salario
select * 
from empleado 
